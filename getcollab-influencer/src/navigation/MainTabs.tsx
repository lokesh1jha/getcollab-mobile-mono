...
import InfluencerDashboard from '../screens/(main)/influencer/dashboard'
import InfluencerDiscover from '../screens/(main)/influencer/discover'
import InfluencerCampaigns from '../screens/(main)/influencer/campaigns'
import InfluencerCampaignDetails from '../screens/(main)/influencer/campaign-details/[id]'
import InfluencerChat from '../screens/(main)/influencer/chat'
...
import VerifyEmailScreen from '../screens/(main)/verify-email'
