...
const styles = StyleSheet.create({
  ...
  gridLineH: { position: 'absolute', left: 0, right: 0, height: StyleSheet.hairlineWidth, backgroundColor: 'rgba(217,255,0,0.09)' },
  gridLineV: { position: 'absolute', top: 0, bottom: 0, width: StyleSheet.hairlineWidth, backgroundColor: 'rgba(217,255,0,0.06)' },
  dot: { position: 'absolute', width: 3, height: 3, borderRadius: 1.5, backgroundColor: 'rgba(217,255,0,0.4)' },
  cornerTL: {
    position: 'absolute', top: 24, left: spacing.xl, width: 18, height: 18,
    borderTopWidth: 1.5, borderLeftWidth: 1.5, borderColor: 'rgba(217,255,0,0.55)',
  },
  cornerBR: {
    position: 'absolute', bottom: 24, right: spacing.xl, width: 18, height: 18,
    borderBottomWidth: 1.5, borderRightWidth: 1.5, borderColor: 'rgba(217,255,0,0.55)',
  },
  ...
  logoBox: {
    width: 38, height: 38, borderRadius: 12, backgroundColor: colors.elevated,
    borderWidth: 1, borderColor: 'rgba(217,255,0,0.28)', alignItems: 'center', justifyContent: 'center',
  },
  ...
  eyebrowDash: { width: 20, height: 2, backgroundColor: colors.neon },
  eyebrow: { color: colors.textMuted, fontSize: 11, fontWeight: '700', letterSpacing: 2 },
  ...
  statsRow: {
    ...
    backgroundColor: 'rgba(255,255,255,0.04)', borderWidth: 1, borderColor: 'rgba(217,255,0,0.18)',
    borderRadius: 20, paddingVertical: spacing.lg, paddingHorizontal: spacing.lg,
    marginBottom: spacing.sm,
  },
  stat: { flex: 1, alignItems: 'center' },
  statDivider: { width: 1, height: 28, backgroundColor: 'rgba(217,255,0,0.18)' },
  statValue: { color: colors.text, fontSize: 18, fontWeight: '700', letterSpacing: -0.3 },
  statLabel: { color: colors.textMuted, fontSize: 11, marginTop: 2, letterSpacing: 0.4 },
