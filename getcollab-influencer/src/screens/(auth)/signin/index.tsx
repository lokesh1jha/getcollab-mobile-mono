...
export default function SignInScreen({ navigation }: Props) {
  ...
  return (
    <View style={styles.root}>
      ...
      <SafeAreaView testID="sign-in-screen" style={{ flex: 1 }} edges={['top', 'bottom']}>
          ...
          <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
            <Animated.View entering={FadeInDown.duration(400)} style={styles.body}>
              ...
              <View style={{ gap: spacing.md, marginTop: spacing.xl }}>
                <FieldInput testID="sign-in-email" label="Email" icon="mail-outline" value={email} onChange={setEmail} error={errors.email} clearError={() => setErrors({ ...errors, email: '' })} placeholder="you@example.com" keyboard="email-address" />
                <FieldInput testID="sign-in-password" label="Password" icon="lock-closed-outline" value={password} onChange={setPassword} error={errors.password} clearError={() => setErrors({ ...errors, password: '' })} placeholder="Enter password" secure />
              </View>
